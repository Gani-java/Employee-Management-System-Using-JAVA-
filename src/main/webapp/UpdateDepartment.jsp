...
<%@ page import="java.sql.*" %>
    <%
        ...
        String sql = "UPDATE department_tbl SET department_name = ? WHERE id = ?";
        ...
        if (departmentId != null && departmentName != null) {
            try {
                ...
                if (rowsAffected > 0) {
                    out.println("<div class='alert alert-success' style='margin-top:140px;''>Department updated successfully.</div>");
                } else {
                    out.println("<div class='alert alert-danger' style='margin-top:140px;''>Error updating department.</div>");
                }
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
