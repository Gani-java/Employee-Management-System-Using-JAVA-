...
<div class="container" style="margin-top:140px;margin-left:250px;">
    <div class="form-group">
        ...
        <select id="department" name="department" class="form-control" onchange="fetchSalaries()" style="width:1000px">
    ...
    <div id="salaryContainer" class="mt-4" style="width:1000px">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete this employee's salary record?</p>
            </div>
...
<script>
    ...
    document.getElementById('confirmDeleteButton').onclick = function() {
        $.ajax({
            url: "deleteSalary.jsp",
            method: "POST",
            data: { employeeId: employeeIdToDelete },
            success: function(response) {
                $('#deleteConfirmationModal').modal('hide');
                fetchSalaries();  // Refresh the salary table after deletion
            }
        });
    }
    ...
    function fetchSalaries() {
        ...
        $.ajax({
            url: "fetchSalaries.jsp",
            method: "GET",
            data: { departmentId: departmentId },
            success: function(data) {
                document.getElementById("salaryContainer").innerHTML = data;
            }
        });
    }
</script>
