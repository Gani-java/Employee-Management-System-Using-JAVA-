...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <div class="breadcrumb">
        ...
        <span class="breadcrumb-item">View Salary</span>
    </div>
</div>
...
<%
    ...
    try {
        ...
        String query = "SELECT basic_salary, allowance, total, added_on FROM salary WHERE employeeId = ?;";
...
%>					
					<tr>
						<td><%= empId %></td>
						<td><%= rs.getLong("basic_salary") %></td>
						<td><%= rs.getLong("allowance") %></td>
						<td><%= rs.getLong("total") %></td>
						<td><%= rs.getDate("added_on") %></td>
					</tr>
