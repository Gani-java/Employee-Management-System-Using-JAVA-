...
<div class="page-header">
    ...
    <div class="breadcrumb">
        ...
        <span class="breadcrumb-item">Update Department</span>
    </div>
</div>
...
<div class="container mt-5" style="margin-left:250px;">
    ...
    <%
        ...
        ResultSet rs = null;
        String sql = "SELECT department_name FROM department_tbl WHERE id = ?";
    ...
    <form action="UpdateDepartment.jsp" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="departmentName" name="departmentName" value="<%= departmentName %>" required>
        </div>
        <button type="submit" class="btn btn-primary">Update</button>
    </form>
    <%
                } else {
                    out.println("<div class='alert alert-danger' style='margin-top:140px;'>Department not found.</div>");
                }
            } catch (Exception e) {
                e.printStackTrace();
                out.println("<div class='alert alert-danger' style='margin-top:140px;'>An error occurred. Please try again later.</div>");
            } finally {
            ...
            out.println("<div class='alert alert-danger' style='margin-top:140px;'>No department ID provided.</div>");
        }
    %>
</div>
